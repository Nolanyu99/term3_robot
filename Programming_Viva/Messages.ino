...
constexpr const char* MESSAGE_BROKER_HOST = "192.168.1.10";
constexpr uint16_t MESSAGE_BROKER_PORT = 1883;

constexpr const char* MESSAGE_TEAM_ID  = "9";
constexpr const char* MESSAGE_BOARD_ID = "destroyer";
...
static void copyPayloadToText(const uint8_t* payload, size_t length,

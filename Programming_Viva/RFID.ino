// =====================================================
// RFID scanner setup and simple scan handling
// Used by Main RobotBehaviour, and ArenaPathfinding
// =====================================================

// Checks whether the reader responded correctly
...
// Prints UID bytes as two hex digits
...
// Initialises the reader while avoiding a fragile soft reset
...
// Checks whether the RFID reader is on the bus
...
// Starts Wire1 and prepares the RFID reader
void setupRFID()
{
...
// Handles one RFID card if present
bool handleRFID()
{
